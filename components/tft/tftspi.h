...
// ** Set the configuration read from Kconfig (make menuconfig -> Components -> TFT Display)
// --------------------------------------------------------
#define DEFAULT_DISP_TYPE           CONFIG_DISP_TYPE
#define DEFAULT_TFT_DISPLAY_WIDTH   CONFIG_DISP_TFT_WIDTH
#define DEFAULT_TFT_DISPLAY_HEIGHT  CONFIG_DISP_TFT_HEIGHT
#define DISP_COLOR_BITS_24          CONFIG_DISP_COLOR_BITS_24
#define DEFAULT_GAMMA_CURVE         CONFIG_DISP_GAMMA_CURVE
#define DEFAULT_SPI_CLOCK           CONFIG_DISP_SPI_CLOCK
#define TFT_INVERT_ROTATION         CONFIG_DISP_INVERT_ROTATION
#define TFT_INVERT_ROTATION1        CONFIG_DISP_INVERT_ROTATION1
#define TFT_INVERT_ROTATION2        CONFIG_DISP_INVERT_ROTATION2
#define TFT_RGB_BGR                 CONFIG_DISP_RGB_BGR

// Hard code no-touch, we don't read any input anyways
#define USE_TOUCH	TOUCH_TYPE_NONE

#define PIN_NUM_MISO CONFIG_DISP_PIN_NUM_MISO		// SPI MISO
#define PIN_NUM_MOSI CONFIG_DISP_PIN_NUM_MOSI		// SPI MOSI
...
#ifndef CONFIG_DISP_INVERT_BCKL_SIGNAL
